...
<footer className=" text-center" style={{borderTop:"2px #282f32 solid"}}>
  <div className="container p-4">
    <section className="social-icons mb-1"  data-aos="zoom-in">
      ...
      ></a>
      <a target="_blank" className="btn btn-outline btn-floating m-1 text-white" href="mailto:bhanu.d.bediya@gmail.com" role="button"
  ...
  <p className="text-center foot-mail">Contact me - <strong>bhanu.d.bediya@gmail.com</strong></p>
  </div>
